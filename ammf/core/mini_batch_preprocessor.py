...
class MiniBatchPreprocessor(object):
    def __init__(self,
                 ...
                 neg_iou_3d_range,
                 pos_iou_3d_range):
        """Preprocesses anchors and saves info to files for p1 training
    ...
    def _calculate_anchors_info(self,
        ...
        p1_iou_type = self.mini_batch_utils.p1_iou_type
        if p1_iou_type == '2d':
            ...
            raise ValueError('Invalid p1_iou_type {}', p1_iou_type)
