...
from ammf.core.proposal_generation_phase import ammf_fc_layer_utils
...
def build_output_layers(tensor_in,
    ...
    # Offsets
    off_out_size = ammf_fc_layer_utils.OFFSETS_OUTPUT_SIZE[box_rep]
    if off_out_size > 0:
    ...
    # Angle Unit Vectors
    ang_out_size = ammf_fc_layer_utils.ANG_VECS_OUTPUT_SIZE[box_rep]
    if ang_out_size > 0:
...
def _early_fusion_fc_layers(num_layers, layer_sizes,
    ...
    # Feature fusion
    fused_features = ammf_fc_layer_utils.feature_fusion(fusion_method,
                                                        input_rois,
                                                        input_weights)
...
def _deep_fusion_fc_layers(num_layers, layer_sizes,
    ...
    # Apply fusion
    fusion_layer = ammf_fc_layer_utils.feature_fusion(fusion_method,
                                                      input_rois,
                                                      input_weights)
