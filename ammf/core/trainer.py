...
from ammf.builders import optimizer_builder
...
def train(model, train_config):
    ...
    Args:
        ...
        train_config: a train_*pb2 protobuf.
            training i.e. loading p1 weights onto ammf model.
    """
    ...
    #2. The model should return a dictionary of predictions
    ...
    #7. Add the result of the train_op to the summary
